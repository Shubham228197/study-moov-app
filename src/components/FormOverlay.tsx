      ...
      <Grid container>
        <Grid className="item1" item sm={12} xs={12}>
          <h3 className="title-main">
            Free consultation with an academic advisor
          </h3>
        </Grid>
              ...
              <tbody>
                <tr>
                  ...
                  <td className="list-content">
                    Get a general idea of ​​the process of admission,
                ...
                <tr>
                  ...
                  <td className="list-content">
                    Get a personal offer based on the results of the
                    conversation.
                  </td>
                </tr>
                <tr>
                  ...
                  <td className="list-content">
                    We will try to understand the aspects that need to be
                ...
                <tr>
                  ...
                  <td className="list-content">
                    Discuss the chances, challenges, and barriers to enrollment
                    and admission.
                  </td>
                </tr>
              </tbody>
        ...
        <Grid className="item4" item sm={12} xs={12}>
          <Stack direction="column">
            ...
            <Stack className="footer">
              <Typography className="bottomline-titile">
                Study
              ...
              <Typography>
                Made with{" "}
                <FavoriteIcon className="arrow-icon" sx={{ color: "red" }} /> in
                Switzerland{" "}
              </Typography>
            </Stack>
          </Stack>
